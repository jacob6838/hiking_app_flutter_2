...
//     list.sort((b, a) => a.compareTo(b)); //reorder from biggest number, so it wont error
...
//           mainList = (snapshot.data ?? []).cast<Map<String, String>>();
//           setState(() {
//             controller.set(mainList?.length);
//           });
//           return WillPopScope(
...
//                       },
//                       child: Container(
//                         decoration: controller.isSelected(index) ? BoxDecoration(color: Colors.grey[300]) : const BoxDecoration(),
//                         child: ListTile(
