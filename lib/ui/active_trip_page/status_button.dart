  ...
  Widget build(BuildContext context) {
    ...
    switch(tripStatus) {
      ...
      case TripStatus.paused:
        return Row(children: [TripCommandButton(TripStatusCommand.unpause, sendCommand), TripCommandButton(TripStatusCommand.stop, sendCommand),]);
      case TripStatus.active:
        return Row(children: [TripCommandButton(TripStatusCommand.pause, sendCommand), TripCommandButton(TripStatusCommand.stop, sendCommand),]);
    }
...
class TripCommandButton extends StatelessWidget {
  ...
  TripPauseButton(this.command, this.sendCommand);
